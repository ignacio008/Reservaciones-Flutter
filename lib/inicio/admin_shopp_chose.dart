...
class AdminShoppChose extends StatefulWidget {
  TiendaModel iconmodel;
  UsuarioModel iconmodelUsuario;
  AdminShoppChose(this.iconmodel, this.iconmodelUsuario);

  @override
  State<AdminShoppChose> createState() => _AdminShoppChoseState();
}

class _AdminShoppChoseState extends State<AdminShoppChose> {
    FToast fToast;
    File _imagen;
    String id_variable="";
...
@override
               ...
               children:[
                 Text("Crear publicidad", style:TextStyle(fontSize:28,fontWeight:FontWeight.bold)),
                    ...
                    GestureDetector(
                       ...
                       Row(
                         children: [
                           Text("Tienda: ", style:TextStyle(fontSize:18, fontWeight:FontWeight.bold)),
                            SizedBox(width:10),
                           Text("${widget.iconmodel.nameShop}", style:TextStyle(fontSize:18,))
                         ],
                       ),
                        SizedBox(height:10),
                       Row(
                         children: [
                           Text("Dueño: ", style:TextStyle(fontSize:18, fontWeight:FontWeight.bold)),
                             SizedBox(width:10),
                           Text("${widget.iconmodel.createBy}", style:TextStyle(fontSize:18,))
                         ],
                       ),
  ...
  void crearPublicidadTienda() async{
    ...
    String nombre_formulario="tienda nombre";
    String telefono_fomrulario="tienda Tel: ";
    String correo_formulario="tienda Correo";
    String comentario_formulario="tienda Comentario ";
    String url_formulario="tienda del tienda Formulario";
   
    int tippPublicidad=2;
    String msnImagen="La imagen no puede estar vacia";
    String msnUrl="El url no puede estar vacio";

    if(_imagen==null){
      showToast(msnImagen);
      return;
    }
    if(url_publicidad_.isEmpty){
      showToast(msnUrl);
      return;
    }
